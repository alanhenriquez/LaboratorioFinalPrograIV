...
<body>
    <a href="/PathToy/login.php" class="volver-button"><i class="fas fa-arrow-left"></i> Volver</a>
    ...
    <div id="descripcionProducto">
        ...
        <textarea id="txtDescripcion" rows="6" placeholder="Ingrese una descripción"></textarea>
    </div>


    <select id="HabilidadJuguete">
        ...
        <option value="opcion3">Habilidades Linguisticas</option>
    </select>

    <div id="PublicoDes">
        <h1>Edad para el publico destinatario</h1>   
    ...
    <button id="realizarButton">Realizar</button>
    <script>
